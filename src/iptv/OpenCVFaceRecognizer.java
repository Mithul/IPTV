...
34  Watch 
  Star 173
 Fork 66bytedeco/javacv
 branch: master  javacv / samples / OpenCVFaceRecognizer.java
Samuel Audetsaudet on May 6 * Add new `OpenCVFaceRecognizer` sample, thanks to Petter Christian …
1 contributor
80 lines (63 sloc)  2.809 kb RawBlameHistory  */
import java.io.File;
...
public class OpenCVFaceRecognizer {
    public static void main(String[] args) {
        ...
        String trainingDir = "/home/mithul/NetBeansProjects/IPTV/build/classes/iptv/";
        Mat testImage = imread("1", CV_LOAD_IMAGE_GRAYSCALE);
